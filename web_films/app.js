...
const filmProvider         = require('./film/FilmProvider');
const hasherProvider       = require('./hasher/hasherProvider');
const routerLoginDashboard = require('./router/RouterLoginDashboard');
const routerLoginHome      = require('./router/RouterLoginHome');
...
app.use(filmProvider(knex));
app.use(authProvider());
app.use(routerDashboard.routes());
app.use(routerLoginDashboard.routes());
app.use(routerLoginHome.routes());
