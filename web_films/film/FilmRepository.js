...
class FilmRepository {
    ...
    async getAllFilm() {
        let filmList = await this.knex('genres').join('films', 'genres.id', '=', 'films.id_genre');
    ...
    factoryFilm(allFilmData) {
        return new Film(allFilmData.id, allFilmData.name, allFilmData.description, allFilmData.status);
    }
}
